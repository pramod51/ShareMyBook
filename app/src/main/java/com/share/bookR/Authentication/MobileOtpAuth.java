...
public class MobileOtpAuth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.v("tag",otp);
                if (otp.isEmpty()){
                    Toast.makeText(MobileOtpAuth.this,"Please Enter 6 Digit OTP",Toast.LENGTH_LONG).show();
                }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(MobileOtpAuth.this,"OTP Verified", Toast.LENGTH_LONG).show();
                            if (task.getResult().getAdditionalUserInfo().isNewUser()) {
                                ...
                                FirebaseFirestore.getInstance().collection("Users").
                                    ...
                                    public void onSuccess(Void unused) {
                                        Intent inte = new Intent(MobileOtpAuth.this, ProfileActivity.class);
                                ...
                                Intent inte = new Intent(MobileOtpAuth.this, MainActivity.class);
                                inte.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(inte);
                            }
                        ...
                        else
                        {
                            progressBar.setVisibility(View.GONE);
                            constants.HideProgressDialog();
                            Toast.makeText(MobileOtpAuth.this,"Verification Failed",Toast.LENGTH_LONG).show();
                        }
                    }
    ...
    private void SendVerificationCode(String phoneN0) {
        ...
        PhoneAuthOptions options =
                PhoneAuthOptions.newBuilder(mAuth)
                        .setPhoneNumber(phoneN0)       // Phone number to verify
                        ...
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                Toast.makeText(MobileOtpAuth.this," Verification Failed \n"+e.getMessage(),Toast.LENGTH_LONG).show();
                            }
