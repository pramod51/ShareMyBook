...
public class AddBookActivity extends AppCompatActivity {
    ...
    private boolean validate() {
        ...
        if (frontCoverUrl.isEmpty()&&backCoverUrl.isEmpty()){
            Toast.makeText(AddBookActivity.this,"Upload Book Cover",Toast.LENGTH_LONG).show();
            return false;
        }
    ...
    /*private void launchCamera() {
        Intent intent =
                CropImage.activity()
                        ...
                        .getIntent(AddBookActivity.this);
        startActivityForResult(intent, CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE);
    }*/

    private void initViews() {

        frontCover = findViewById(R.id.front_cover);
        backCover= findViewById(R.id.back_cover);
        uploadFrontCover= findViewById(R.id.upload_front_cover);
        uploadBackCover= findViewById(R.id.upload_back_cover);
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                try {
                    ...
                    constants.ProgressDialogShow(AddBookActivity.this);
...
//                        progressBar.setVisibility(View.GONE);
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddBookActivity.this, "Failed to upload! Try Again :)", Toast.LENGTH_LONG).show();
